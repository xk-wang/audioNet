...
def parse_args():
    ...
    parser.add_argument('--onset-win', type=float, default=0.1)
    parser.add_argument('--offset-win', type=float, default=0.1)
...
if __name__=='__main__':
    ...
    op = [[], [], []]
    oop = [[], [], []]
    # raise ValueError(onset_win)
    for filename in filenames:
        # if filename in ["yty26_2x8_4.txt", "yty20_3x8_5.txt",  "yty20_6x8_8.txt"]: 
        #     continue
        ...
        oop[2].append(r)
        if offset:
            print(filename, '\nop F1: %4.2f%% P: %4.2f%% R:  %4.2f%%'%(f, p, r))
